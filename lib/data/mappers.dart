...
ActorUIModel mapActorDataModelToUI(ActorDataModel actorDataModel) {
  return ActorUIModel(
...
FilmStaffMemberUIModel mapFilmStaffMemberDataModelToUI(
...
List<FilmStaffMemberUIModel> mapFilmStaffMemberDataListToUI(
    List<FilmStaffMemberDataModel> actorsDataModelList) {
  return actorsDataModelList.map(mapFilmStaffMemberDataModelToUI).toList();
}
